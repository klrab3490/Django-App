...
$(document).ready(function()
{
	...
	*/
	...
	function initGoogleMap() {
		var myLatlng = new google.maps.LatLng(34.063685,-118.272936); // Current Coordinates
		var mapOptions = {
			center: myLatlng, // Set the map's center
			zoom: 14, // Set zoom level
			mapTypeId: google.maps.MapTypeId.ROADMAP, // Map type
			draggable: true, // Allow dragging
			scrollwheel: false, // Disable zoom by scroll wheel
